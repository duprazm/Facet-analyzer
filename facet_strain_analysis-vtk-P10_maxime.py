...
disp_range = planar_dist/2
strain_range = 0.00075
disp_range_avg = planar_dist/3
...
pathdir = '/home/maxime/Documents/maxime/Reseau/nili/analysis/Pt/P10/align_02_%05d/pynxraw/modes_crop/'
#'/data/id01/inhouse/nili/analysis/Pt/P10/align_02_%05d/pynxraw/modes_crop/'
pathsave = '/home/maxime/Documents/maxime/Documents/Post_doc_esrf/Beamtimes/Petra_05_2019/facet_analyzer/results/crystal_4/align_02_%05d/'
...
ax.view_init(elev=-64, azim=94)
plt.show()
plt.savefig(pathsave%scan+ name + '_strain_3D_' + hkls + '_' +str(strain_range) +'.png')
